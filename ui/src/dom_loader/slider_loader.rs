...
fn increment_decrement_pointer_slider_loader(
    ...
    Ok(IncrementDecrementPointerSlider::new(
        ...
        get_font_size_or_default(&minidom_element, default_font_size),
        get_color_attribute_or_default(&minidom_element, default_color),
        ...
        get_size_or_default(&minidom_element, Default::default()).x,
        (
...
fn quad_color_picker_loader(
    ...
    let size = get_size_or_default(&minidom_element, Default::default());
...
pub fn slider_loader(
    ...
    default_font_size: u32,
    default_color: Color,
) -> Result<Box<dyn SliderElement>, Box<dyn Error>> {
